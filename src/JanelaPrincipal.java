...
public class JanelaPrincipal extends JFrame {
    ...
    public JanelaPrincipal() {
        ...
        setTitle("Sistema de Cadastro de Alunos - CRUD");
        setSize(700, 500);
        ...
        JPanel cadastroCompleto = new JPanel(new BorderLayout());
        cadastroCompleto.add(painelCadastro, BorderLayout.CENTER);
        cadastroCompleto.add(painelBotoes, BorderLayout.SOUTH);

        abas.add("Cadastro", cadastroCompleto);

        // ======================== LISTA ==========================
        modeloTabela = new DefaultTableModel(new Object[]{
                "ID", "Nome", "Email", "Curso", "Cidade"
        }, 0);
